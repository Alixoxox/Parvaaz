...
router.post('/search',(req,res)=>{
    ...
    if((flight_code && flight_code.trim()!=='') || (country && country.trim()!=='') || (airline_code && airline_code.trim()!=='')){
        const sql1=`SELECT f.flight_code,fs.departure_time,fs.arrival_time,fs.origin,fs.destination ,a.airline_code,a.name as airline_name, a.country as airline_country,fs.available_seats FROM flights f , airlines a ,flight_schedules fs
